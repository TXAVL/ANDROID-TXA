...
if errorlevel 1 (
    ...
    echo ✅ Remote added: https://github.com/TXAVL/ANDROID-TXA.git
) else (
    REM Kiểm tra xem remote có đúng repo không
    ...
    if errorlevel 1 (
        ...
        echo ✅ Remote updated: https://github.com/TXAVL/ANDROID-TXA.git
    ) else (
